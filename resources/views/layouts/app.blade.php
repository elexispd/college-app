...
<html lang="en">
    ...
    <body class="loading" data-layout-color="light"  data-layout-mode="default" data-layout-size="fluid" data-topbar-color="light" data-leftbar-position="fixed" data-leftbar-color="light" data-leftbar-size='default' data-sidebar-user='true'>
            ...
            <div class="content-page">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
                                <script>document.write(new Date().getFullYear())</script> &copy; PCIT by <a href="">Corper Promise</a>
                            </div>
                            <div class="col-md-6">
                                <div class="text-md-end footer-links d-none d-sm-block">
                                    <a href="javascript:void(0);">About Us</a>
                                    <a href="javascript:void(0);">Help</a>
                                    <a href="tel:+2348181346796">Contact Us</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="right-bar">
            ...
            <div data-simplebar class="h-100">
                ...
                <div class="rightbar-title">
                    ...
                    <h4 class="font-16 m-0 text-white">Customize View</h4>
                </div>
        ...
        <!--Morris Chart-->
        <script src="{{ asset('libs/morris/morris.min.js') }}"></script>
